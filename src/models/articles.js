    ...
    items: [
        {
            ...
            title: 'ICFP Contest 2017 — проверка на прочность для настоящих разработчиков',
            dateString: 'сентябрь 2017',
            tags: ['contest'],
            linkToSlides: 'https://habrahabr.ru/company/skbkontur/blog/334324/',
            annotation: (
                <div>
                    <p>
                        ICFP Contest — ежегодное соревнование для программистов. Оно проходит в онлайне и длится 72 часа.
                        ICFPC 2017 начнётся в пятницу 4 августа в 12:00 (UTC) и закончится в понедельник. Я расскажу,
                        почему нельзя пропускать ICFPC и дам серию советов по участию в этом соревновании для вдумчивых хакеров.
                    </p>
                </div>
            ),
        },
        {
            ...
            title: 'Сказ о стажировке в маленькой компании или как мы с Контуром конкурировали [Часть I]',
            dateString: 'март 2017',
            tags: ['management', 'education'],
            linkToSlides: 'https://habrahabr.ru/company/skbkontur/blog/321614/',
            annotation: (
                <div>
                    <p>
                        В этом году я уже в третий раз буду наставником на контуровской летней стажировке, но первый
                        опыт проведения стажировки я получил в маленькой компании до Контура. Сейчас, спустя почти
                        четыре года, я хочу поделиться этим опытом и провести некоторые параллели с тем, как проходит
                        стажировка в большой компании. Надеюсь, прочитав этот текст, вы тоже решитесь на организацию
                        стажировки. Буду рад, если мой опыт вам в этом поможет!
                    </p>
                    <p>
                        Под катом первая часть повествования, из которой вы узнаете, почему мы решили проводить свою
                        маленькую стажировку, как мы её видели и планировали. По каждому пункту постараюсь привести
                        сравнительные примеры, как на аналогичные вопросы отвечают в Контуре, — где-то мы были
                        ограничены в ресурсах, в чём-то нам не хватало опыта, а по каким-то этапам стажировки наши
                        подходы совпадали.
                    </p>
                    <p>
                        Во второй части расскажу о том, как всё получилось на самом деле, какие выводы мы сделали
                        и чему научились.
                    </p>
                </div>
            ),
