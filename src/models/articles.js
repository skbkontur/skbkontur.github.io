...
const articles: Article[] = [
        ...
        annotation: (
            <div>
                <p>
                    ...
                    версию под iOS, но на этот раз на базе <strong>Xamarin</strong> и <strong>Xamarin.Forms</strong>,
                    и нам не терпится поделиться опытом. Пока что мы успели рассмотреть разработку только
    ...
    },
    {
        speakerFullName: '',
        title:
            'QCTF Starter: компьютерная безопасность на четверых или' +
            ' как мы сделали турнир для новичков в 19 городах одновременно',
        ...
        annotation: (
            <div>
                <p>
                    ...
                    Про них <a href='https://habrahabr.ru/post/64216/'>тут</a> хорошо написано.
                    Чтобы участвовать в серьёзных CTF-турнирах нужна неслабая подготовка, но мало
                    кто знает, как и где её получить. Мы решили исправить это, а именно — провести
                    массовые соревнования по компьютерной безопасности для новичков. И назвали их
                    QCTF Starter. Возможно, для участников это станет первой ступенькой на пути к
                    профессиональным CTF-турнирам.
                </p>
            </div>
        ),
    },
        ...
        annotation: (
            <div>
                <p>
                    ...
                    говоря, я этого вообще больше нигде не видел).
                    То есть ожидать-то не стоит, но «срывы покровов» произойдут :)
                </p>
            </div>
        ),
    },
        ...
        annotation: (
            <div>
                <p>
                    ...
                    налоги и отправлять декларации через интернет — про это мы расскажем
                    как-нибудь в следующих публикациях.
                </p>
                <p>
