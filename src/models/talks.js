...
export default {
    additionalFooterText:
        <noindex>
            Фотографии докладчиков взяты из видео выступлений и фотоархивов соответствующих конференций.
            Рядом с каждым выступлением есть ссылка на сайт конференции, который является источником фотографии.
        </noindex>,
