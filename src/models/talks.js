...
export default {
    ...
    items: [
        ...
        {
            image: ,
            speakerFullName: 'Юрий Плинер',
            eventName: '.NET meetup Екб',
            title: 'Эволюция логирования на примере одного проекта',
            dateString: 'апрель 2017',
            tags: ['backend', '.net'],
            linkToVideo: 'https://www.youtube.com/watch?v=5KmmLXfqTK8',
            linkToSlides: 'https://vk.com/doc1499661_445544429?hash=6c4bdfa0be2d272f3d&dl=242bab1f351b804a79',
            linkToEvent: dotnetEkbLink,
        },
        {
