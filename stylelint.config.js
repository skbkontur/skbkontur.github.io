...
module.exports = {
    ...
    rules: {
        ...
        // DISABLED 'declaration-empty-line-before': 'never',
        ...
        'no-unsupported-browser-features': [true, { browsers: 'last 2 versions, ie >= 10', ignore: 'flexbox' }],
        ...
        // http://stylelint.io/user-guide/rules/rule-nested-empty-line-before/
        'rule-nested-empty-line-before': ['always-multi-line', { except: ["first-nested"], ignore: ["after-comment"] }],
        ...
        // http://stylelint.io/user-guide/rules/stylelint-disable-reason/
